# Attaché à un Area3D
# L'Area3D sert ici à détecter quand le joueur entre dans la zone de fin du parcours
extends Area3D
...
# Indique au GameManager que le parcours est terminé
		gm.parcours_fini = true
